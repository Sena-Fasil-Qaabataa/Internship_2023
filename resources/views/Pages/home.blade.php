...
<div class="container">
  <div class="row">
    <div class="col-sm-4">
      <h2><abbr title="Model">M</abbr></h2>
      <p>The Model component represents the data and business logic of the application.</p>
      <p>It interacts with the database, processes user input, and communicates with the Controller to update the View.</p>
    </div>
    <div class="col-sm-4">
      <h2><abbr title="View">V</abbr></h2>
      <p>The View component is responsible for the presentation layer of the application ...</p>
